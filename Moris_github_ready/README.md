# MORIS — Luxury Telegram File Infrastructure

MORIS Pro is a production-oriented Telegram file uploader with PostgreSQL, Redis queueing, multi-file web upload, automatic expiry cleanup, webhook support and a polished Persian admin control center.
